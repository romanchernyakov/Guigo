...
button.addEventListener('click', function(){
    ...
    let gallery = ['assets/p3.jpg','assets/p1.jpg','assets/p4.jpg']
...
weather.open('GET','https://goweather.herokuapp.com/weather/Moscow', true)
weather.onreadystatechange = function() {
    if (weather.readyState == 4) {
        if (weather.status == 200) {
            ...
            let windTommorow = data.forecast[0].wind
            let forecastTommorow = document.querySelector('.weather-api-tommorow')
            forecastTommorow.innerHTML = temperatureTommorow + ' & wind ' + windTommorow
        }
    }
}
weather.send(null)
